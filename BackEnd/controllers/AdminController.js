...
const ACCESS_TOKEN = "db722c5d642a6ea92f4080d1af55541de5a9646084b5c3ac0b713832ef2fa39da0541243858e2487f33aacbbcf35429a84d954aab55a0de71b4f9feebfc95fa2"
...
export async function createAdmin(req, res){
    ...
    try {
        documento = await AdminModel.create({"Usuario":Usuario.Usuario,"Password":secPassw })//Usuario como objto json
    } catch (error) {
...
export async function loginAdmin(req, res){
    ...
    try {
        ...
        if(acceso){
            ...
            res.sendStatus(401)//.json(documento)
        }
